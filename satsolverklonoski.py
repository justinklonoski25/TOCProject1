...
def save_results_to_csv(results, output_filename, wff_length, input_filename):
    with open(output_filename, 'w', newline='') as file:
        ...
        writer.writerow(["Problem Number, Number of Variables, Number of Clauses, Maximum Number of Literals (k), Total Number of Literals, S/U, Test Code Answer, Execution Time (μs), Assignment"])
